...
class ModelDialogHandler @Inject constructor(){
    ...
    fun createDialog(activity:FragmentActivity,dialog: ModelDialog):AppCompatDialog?{
        val alertDialog = HomerentDialogBox.showAlertDialog(
            activity = activity,
            ...
            buttonClickListener = object : HomerentDialogBox.ButtonClickListener(){
            ...
            dialogPrimaryColor = HomerentDialogBox.DialogPrimaryColor.Cyan,
